...
=== "Survol pendant le glisser-déposer"
    ...
    <figure markdown="span">
      ![Survol de la zone de dépôt](/assets/screenshots/ui/dropzone-hover-fr.png){ loading=lazy }
...
=== "Téléversement"
    ...
    <figure markdown="span">
      ![Téléversement](/assets/screenshots/ui/dropzone-uploading-fr.png){ loading=lazy }
...
<figure markdown="span">
  ![En-tête](/assets/screenshots/ui/header-fr.png){ loading=lazy }
...
=== "Liste d’historique"
    ...
    <figure markdown="span">
      ![Panneau d’historique](/assets/screenshots/ui/history-panel-fr.png){ loading=lazy }
...
=== "Recherche"
    ...
    <figure markdown="span">
      ![Recherche dans l’historique](/arch.png){ loading=lazy }
...
<figure markdown="span">
  ![Paramètres des tableaux](/assets/screenshots/settings/settings-tables-fr.png){ loading=lazy }
...
<figure markdown="span">
  ![Paramètres des images](/assets/screenshots/settings/settings-images-fr.png){ loading=lazy }
...
<figure markdown="span">
  ![Paramètres de performance](/assets/screenshots/settings/settings-performance-fr.png){ loading=lazy }
...
<figure markdown="span">
  ![Paramètres de chunking](/assets/screenshots/settings/settings-chunking-fr.png){ loading=lazy }
...
<figure markdown="span">
  ![Paramètres de sortie](/assets/screenshots/settings/settings-output-fr.png){ loading=lazy }
...
=== "Format sélectionné"
    ...
    <figure markdown="span">
      ![Format sélectionné](/assets/screenshots/export/export-format-selected-fr.png){ loading=lazy }
...
=== "HTML rendu"
    ...
    <figure markdown="span">
      ![HTML rendu](/assets/screenshots/export/preview-html-rendered-fr.png){ loading=lazy }
...
=== "HTML brut"
    ...
    <figure markdown="span">
      ![HTML brut](/assets/screenshots/export/preview-html-raw-fr.png){ loading=lazy }
...
=== "En cours"
    ...
    <figure markdown="span">
      ![Conversion en cours](/assets/screenshots/features/conversion-progress-fr.png){ loading=lazy }
...
=== "Score de confiance"
    ...
    <figure markdown="span">
      ![Affichage de la confiance](/assets/screenshots/features/confidence-display-fr.png){ loading=lazy }
...
=== "Liste des tableaux"
    ...
    <figure markdown="span">
      ![Liste des tableaux](/assets/screenshots/features/tables-list-fr.png){ loading=lazy }
...
=== "Options de téléchargement"
    ...
    <figure markdown="span">
      ![Téléchargement tableaux](/assets/screenshots/features/tables-download-fr.png){ loading=lazy }
...
<figure markdown="span">
  ![Liste des fragments](/assets/screenshots/features/chunks-list-fr.png){ loading=lazy }
