...
- [Conversión Pipeline](../ConversiónPipeline.png)
- [Procesamiento por lotes](../BatchProcesyo.png)
- [Escalado Arquitectura](../EscaladoArquitectura.png)
