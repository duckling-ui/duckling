...
Por defecto las conversiones se ejecutan in-process (`local`). Redis/RQ/Ray y batch conectores requieren integración de workers. Ver [Configuración del servidor](../deployment/server-config.md).
