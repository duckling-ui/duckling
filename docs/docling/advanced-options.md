# Advanced options (Docling)

!!! note "Vendored from upstream Docling"
    Source: `docling-project/docling` (`docs/usage/advanced_options.md`, ref `main`).
...
The example file [custom_convert.py](https://github.com/docling-project/docling/blob/main/docs/examples/custom_convert.py) contains multiple ways
