...
!!! note "Vendored from upstream Docling"
    Source: `docling-project/docling` (`docs/usage/supported_formats.md`, ref `main`).
...
[Architecture](architecture.md) for more details.
...
| Docling JSON | JSON-serialized [Docling Document](docling-document.md) |
