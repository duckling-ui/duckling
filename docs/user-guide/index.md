...
!!! tip "Multiple files"
    Drag in several files, pick a folder, or use **Choose files…**—the same drop zone handles single and multi-file uploads. The job queue processes up to 2 conversions in parallel to balance speed and memory.
