...
- **2026-05-01**: Frontend container baseline update: production frontend image now pins `nginx:1.29-alpine3.22` to reduce Alpine OS-package CVE exposure found by Trivy in older `nginx:1.27-alpine` images (OpenSSL/libxml/musl/zlib families).
